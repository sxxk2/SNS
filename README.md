...
- id=4 계정의 토큰으로 id=1 계정 정보 수정시

<br><br><br>

- 회원 탈퇴 (비활성화) 성공 (id=4 계정의 토큰으로 id=4 회원 탈퇴시)
...
- 게시물 id=35의 작성자id=2, 토큰의 계정 id=4
